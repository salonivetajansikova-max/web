          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <MapPin size={20} strokeWidth={1} className="text-violet shrink-0 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Phone size={20} strokeWidth={1} className="text-violet shrink-0 mt-1" />
                <div>
                  <p className="font-body text-[11px] uppercase tracking-[0.15em] text-gray mb-1">Telefon</p>
                  <a href="tel:736401118" className="font-body text-[18px] text-dark hover:text-violet transition-colors">
                    736 401 118
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <Mail size={20} strokeWidth={1} className="text-violet shrink-0 mt-1" />
                <div>
                  <p className="font-body text-[11px] uppercase tracking-[0.15em] text-gray mb-1">E-mail</p>
                  <a href="mailto:iveta.jansikova@seznam.cz" className="font-body text-[15px] text-dark hover:text-violet transition-colors">
              ...
              <div className="flex items-start gap-4">
                <Clock size={20} strokeWidth={1} className="text-violet shrink-0 mt-1" />
                <div>
            ...
            <a
              href="tel:736401118"
              className="mt-10 inline-block font-body text-[12px] uppercase tracking-[0.1em] bg-violet text-white border border-violet px-9 py-3.5 hover:bg-[#7A6A97] transition-all duration-200"
            >
              Zavolat
            </a>
          </div>
